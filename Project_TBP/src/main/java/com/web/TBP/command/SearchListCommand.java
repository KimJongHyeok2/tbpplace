...
public class SearchListCommand extends Command {
	...
	public void execute(Model model) {
		...
		int searchAllCount = dao.searchAllCount(searchValue);
		
		List<SearchDTO> searchDto = dao.selectSearch(searchValue, (page-1)*allRow+1, allRow);
		
		Set<Integer> categoryCount = dao.selectCategorys(searchValue);
		...
		model.addAttribute("pageType", "normal");
	}
